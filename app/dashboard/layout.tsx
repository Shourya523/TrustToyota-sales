import { LayoutDashboard, LogOut, Settings, Car } from "lucide-react";
    ...
    <div className="flex h-screen bg-[#09090b] text-zinc-50 overflow-hidden font-sans">
      ...
      <aside className="w-64 border-r border-zinc-800 bg-[#09090b] flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-3 py-2 bg-zinc-800/50 text-zinc-100 rounded-md transition-colors border border-zinc-700/50"
          >
            <LayoutDashboard className="w-4 h-4 text-[#EB0A1E]" />
